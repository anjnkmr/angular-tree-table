export declare class TreeTableDataConfig {
     ...
     * Default value is `false`
     */
    excelExportOnlyFilteredRows?: boolean;
    /**
    ...
    expandableArrowPlacement?: ExpandableArrowPlacement;
}
export declare enum ExpandableType {
    DIFFERENT_HEADERS = "DIFFERENT_HEADERS",
    SAME_HEADERS = "SAME_HEADERS"
}
export declare enum ExpandableArrowPlacement {
