...
/***/ "./dist/angular-tree-table/fesm5/angular-tree-table.js":
/*!*************************************************************!*\
  !*** ./dist/angular-tree-table/fesm5/angular-tree-table.js ***!
  \*************************************************************/
...
var TreeTableData = /** @class */ (function () {
    ...
    function () {
        ...
        try {
            for (var colSearchKeys_1 = Object(tslib__WEBPACK_IMPORTED_MODULE_1__["__values"])(colSearchKeys), colSearchKeys_1_1 = colSearchKeys_1.next(); !colSearchKeys_1_1.done; colSearchKeys_1_1 = colSearchKeys_1.next()) {
    ...
    function (callback) {
        ...
        if (this.serverConfig.method === 'GET') {
            ...
            function (resp) {
                ...
                Object(file_saver__WEBPACK_IMPORTED_MODULE_3__["saveAs"])(blob, 'Orders.xlsx');
            }));
        }
    };
    /**
            ...
            function (resp) {
                ...
                if (callback !== undefined && callback !== null) {
                    ...
                    if (resp[_this.serverConfig.rowsKey] === undefined || resp[_this.serverConfig.rowsKey] === null) {
                        ...
                        try {
                            for (var _b = Object(tslib__WEBPACK_IMPORTED_MODULE_1__["__values"])(resp[_this.serverConfig.rowsKey]), _c = _b.next(); !_c.done; _c = _b.next()) {
                                var rawRow = _c.value;
                                /** @type {?} */
                                var uniqueVal = null;
...
var AngularTreeTableComponent = /** @class */ (function () {
    ...
    function (pageNumber) {
        ...
        if (this.tableData.serverConfig.url !== undefined && this.tableData.serverConfig.url !== null) {
            ...
            function (rows) {
                ...
                try {
                    for (var rows_1 = Object(tslib__WEBPACK_IMPORTED_MODULE_1__["__values"])(rows), rows_1_1 = rows_1.next(); !rows_1_1.done; rows_1_1 = rows_1.next()) {
            ...
            function (v) {
                ...
                if (_this.tableData.keyword !== undefined && _this.tableData.keyword !== null && _this.tableData.keyword.trim() !== '') {
                    try {
                        for (var keys_1 = Object(tslib__WEBPACK_IMPORTED_MODULE_1__["__values"])(keys), keys_1_1 = keys_1.next(); !keys_1_1.done; keys_1_1 = keys_1.next()) {
                ...
                if (matched && _this.tableData.config.columnFilters !== undefined && _this.tableData.config.columnFilters !== null) {
                    try {
                        for (var keys_2 = Object(tslib__WEBPACK_IMPORTED_MODULE_1__["__values"])(keys), keys_2_1 = keys_2.next(); !keys_2_1.done; keys_2_1 = keys_2.next()) {
                            ...
                            if (_this.tableData.config.columnFilters[key] !== undefined &&
                                ...
                                var orMatch = false;
                                try {
                                    for (var _e = (e_6 = void 0, Object(tslib__WEBPACK_IMPORTED_MODULE_1__["__values"])(_this.tableData.config.columnFilters[key])), _f = _e.next(); !_f.done; _f = _e.next()) {
                ...
                if (matched && _this.tableData.config.visibleColumnFilters !== undefined && _this.tableData.config.visibleColumnFilters !== null) {
                    try {
                        for (var keys_3 = Object(tslib__WEBPACK_IMPORTED_MODULE_1__["__values"])(keys), keys_3_1 = keys_3.next(); !keys_3_1.done; keys_3_1 = keys_3.next()) {
    ...
    function () {
        ...
        var dataRows = [];
        try {
            for (var _c = Object(tslib__WEBPACK_IMPORTED_MODULE_1__["__values"])(this.tableData.data), _d = _c.next(); !_d.done; _d = _c.next()) {
                var d = _d.value;
                /** @type {?} */
                var obj = {};
                try {
                    for (var _e = (e_9 = void 0, Object(tslib__WEBPACK_IMPORTED_MODULE_1__["__values"])(this.tableData.headers)), _f = _e.next(); !_f.done; _f = _e.next()) {
                        var h = _f.value;
        ...
        /** @type {?} */
        var ws = xlsx__WEBPACK_IMPORTED_MODULE_4__["utils"].json_to_sheet(dataRows);
        /** @type {?} */
        var wb = { Sheets: { data: ws }, SheetNames: ['data'] };
        /** @type {?} */
        var excelBuffer = Object(xlsx__WEBPACK_IMPORTED_MODULE_4__["write"])(wb, { bookType: 'xlsx', type: 'array' });
        /** @type {?} */
        var data = new Blob([excelBuffer], { type: fileType });
        Object(file_saver__WEBPACK_IMPORTED_MODULE_3__["saveAs"])(data, this.tableData.config.excelExportFileName + fileExtension);
    };
    /**
     * @param {?} header
     * @return {?}
    ...
    function (row) {
        ...
        try {
            for (var _b = Object(tslib__WEBPACK_IMPORTED_MODULE_1__["__values"])(row.classes), _c = _b.next(); !_c.done; _c = _b.next()) {
                var cls = _c.value;
                classes[cls] = true;
            }
        }
    ...
    function () {
        /** @type {?} */
        var rows = Object(tslib__WEBPACK_IMPORTED_MODULE_1__["__spread"])(this.tableData.data.filter((/**
         * @param {?} v
         * @return {?}
         */
        function (v) {
...
/* harmony import */ var angular_tree_table__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! angular-tree-table */ "./dist/angular-tree-table/fesm5/angular-tree-table.js");
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var angular_tree_table__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! angular-tree-table */ "./dist/angular-tree-table/fesm5/angular-tree-table.js");
...
var BasicComponent = /** @class */ (function () {
    ...
    BasicComponent.prototype.populateDummyData = function () {
        var data = [];
        for (var i = 0; i < 120; i++) {
            var row = new angular_tree_table__WEBPACK_IMPORTED_MODULE_2__["TreeTableRow"](i + '', { sno: i + 1, name: 'John ' + (i + 1), age: i + 1 }, false, null);
            data.push(row);
        }
    ...
    BasicComponent.prototype.populateHeaders = function () {
...
var ExpandableHeaderLessComponent = /** @class */ (function () {
    function ExpandableHeaderLessComponent() {
        this.tableData = null;
        this.tableConfig = {
    ...
    ExpandableHeaderLessComponent.prototype.ngOnInit = function () {
        this.populateDummyData();
    };
    ExpandableHeaderLessComponent.prototype.populateDummyData = function () {
        var data = [];
        for (var i = 0; i < 120; i++) {
            var row = new angular_tree_table__WEBPACK_IMPORTED_MODULE_2__["TreeTableRow"](i + '', { sno: i + 1, name: 'John ' + (i + 1), age: i + 1 }, false, null);
            if (i % 10 !== 0) {
                ...
                for (var j = 0; j < (10 - i % 10); j++) {
                    var subRow = new angular_tree_table__WEBPACK_IMPORTED_MODULE_2__["TreeTableRow"](j + '', { sno: j + 1, name: 'Paul ' + (j + 1), age: j + 1 }, false, null);
                    subData.push(subRow);
                }
    ...
    ExpandableHeaderLessComponent.prototype.populateHeaders = function () {
        this.tableHeaders.splice(0, this.tableHeaders.length);
        this.tableHeaders.push(new angular_tree_table__WEBPACK_IMPORTED_MODULE_2__["TreeTableHeaderObject"]('Sno', 'sno', null, true));
        this.tableHeaders.push(new angular_tree_table__WEBPACK_IMPORTED_MODULE_2__["TreeTableHeaderObject"]('Name', 'name', null, true));
        this.tableHeaders.push(new angular_tree_table__WEBPACK_IMPORTED_MODULE_2__["TreeTableHeaderObject"]('Age', 'age', null, true));
    ...
    return ExpandableHeaderLessComponent;
}());
...
var ExpandableComponent = /** @class */ (function () {
    ...
    ExpandableComponent.prototype.populateDummyData = function () {
        var data = [];
        for (var i = 0; i < 120; i++) {
            var row = new angular_tree_table__WEBPACK_IMPORTED_MODULE_2__["TreeTableRow"](i + '', { sno: i + 1, name: 'John ' + (i + 1), age: i + 1 }, false, null);
            if (i % 10 !== 0) {
    ...
    ExpandableComponent.prototype.populateHeaders = function () {
        this.tableHeaders.splice(0, this.tableHeaders.length);
        this.tableHeaders.push(new angular_tree_table__WEBPACK_IMPORTED_MODULE_2__["TreeTableHeaderObject"]('Sno', 'sno', null, true));
        this.tableHeaders.push(new angular_tree_table__WEBPACK_IMPORTED_MODULE_2__["TreeTableHeaderObject"]('Name', 'name', null, true));
        this.tableHeaders.push(new angular_tree_table__WEBPACK_IMPORTED_MODULE_2__["TreeTableHeaderObject"]('Age', 'age', null, true));
...
var InputsComponent = /** @class */ (function () {
    ...
    InputsComponent.prototype.populateDummyData = function () {
        var data = [];
        for (var i = 0; i < 120; i++) {
            var row = new angular_tree_table__WEBPACK_IMPORTED_MODULE_2__["TreeTableRow"](i + '', { sno: i + 1, name: 'John ' + (i + 1), age: i + 1 }, false, null);
            row.options = [
    ...
    InputsComponent.prototype.populateHeaders = function () {
        this.tableHeaders.splice(0, this.tableHeaders.length);
        this.tableHeaders.push(new angular_tree_table__WEBPACK_IMPORTED_MODULE_2__["TreeTableHeaderObject"]('Sno', 'sno', null, true));
        this.tableHeaders.push(new angular_tree_table__WEBPACK_IMPORTED_MODULE_2__["TreeTableHeaderObject"]('Name', 'name', null, true));
        var ageHeader = new angular_tree_table__WEBPACK_IMPORTED_MODULE_2__["TreeTableHeaderObject"]('Age', 'age', null, true);
        ageHeader.dataType = angular_tree_table__WEBPACK_IMPORTED_MODULE_2__["TtDataType"].INPUT_TEXT;
        this.tableHeaders.push(ageHeader);
        var diedHeader = new angular_tree_table__WEBPACK_IMPORTED_MODULE_2__["TreeTableHeaderObject"]('Died', 'died', null, true);
...
var SelectComponent = /** @class */ (function () {
    ...
    SelectComponent.prototype.populateDummyData = function () {
        var data = [];
        for (var i = 0; i < 120; i++) {
            var row = new angular_tree_table__WEBPACK_IMPORTED_MODULE_2__["TreeTableRow"](i + '', { sno: i + 1, name: 'John ' + (i + 1), age: i + 1 }, false, null);
            data.push(row);
    ...
    SelectComponent.prototype.rowSelectionChanged = function (selected) {
        console.log('Selection changed', selected);
    };
    SelectComponent.prototype.populateHeaders = function () {
        this.tableHeaders.splice(0, this.tableHeaders.length);
        var selectAllHeader = new angular_tree_table__WEBPACK_IMPORTED_MODULE_2__["TreeTableHeaderObject"]('Select All', null, null, true);
...
var ServerSideComponent = /** @class */ (function () {
