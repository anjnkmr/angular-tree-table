...
import { TreeTableData, TreeTableHeaderObject, TreeTableRow } from 'projects/angular-tree-table/src/public-api';

@Component({
  selector: 'app-expandable-fixed-visibility',
  templateUrl: './expandable-fixed-visibility.component.html',
  styleUrls: ['./expandable-fixed-visibility.component.scss']
})
export class ExpandableFixedVisibilityComponent implements OnInit {
  ...
  populateHeaders() {
    ...
    this.tableHeaders.push(new TreeTableHeaderObject('Name', 'name', null, true, false));
